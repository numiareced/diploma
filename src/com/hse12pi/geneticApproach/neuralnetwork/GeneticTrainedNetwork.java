...
import com.hse12pi.geneticApproach.geneticAlgorithm.Chromosome;


public class GeneticTrainedNetwork extends NeuralNetwork implements Chromosome<GeneticTrainedNetwork>, Cloneable {
	...
	public GeneticTrainedNetwork() {
		// Required by JAXB
	}

	public GeneticTrainedNetwork(int numberOfNeurons) {
		super(numberOfNeurons);
	}

	public GeneticTrainedNetwork(NeuralNetwork nn) {
	...
	@Override
	public List<GeneticTrainedNetwork> crossover(GeneticTrainedNetwork anotherChromosome) {
		GeneticTrainedNetwork anotherClone = anotherChromosome.clone();
		GeneticTrainedNetwork thisClone = this.clone();
	...
	@Override
	public GeneticTrainedNetwork mutate() {
		GeneticTrainedNetwork mutated = this.clone();
	...
	@Override
	public GeneticTrainedNetwork clone() {
		GeneticTrainedNetwork clone = new GeneticTrainedNetwork(this.neurons.size());
